...
export default function Page() {
  ...
  async function planTrip() {
    ...
    try {
      ...
      const perDay = Math.max(2, Math.min(3, Math.ceil(data.pois.length / days || 2)));
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-sky-50 to-emerald-50 p-4 lg:p-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-6 items-start">
        <div className="relative w-full aspect-[16/10] rounded-2xl shadow-2xl overflow-hidden border border-slate-200">
